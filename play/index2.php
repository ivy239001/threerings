...
<body>
  <div id="main-container">
    ...
    <div id="sidebar">
      <div class="userinfo">
        <div>マイページ</div>
        <div>ユーザー名：<?php echo htmlspecialchars($user_name); ?></div>
        <!-- ユーザー名表示 -->
        <div>ログイン回数：<?php echo htmlspecialchars($login_count); ?></div>
        <!-- ログイン回数表示 -->
      </div>
      <div class="rules-container">
        <div class="rules active">
          <strong>ルール説明①</strong><br>
          <br> ４人（もしくは２人で２色使用）でプレーするボードゲームです。<br> 各プレーヤーはそれぞれ赤、青、緑、紫のリングを所持します。リングには大・中・小の３種類があり３つずつ所持しています。<br> 手持ちのリングの中から１つ選択しボードに配置します（配置後移動はできません）。<br> 異なるサイズのリングであれば１つのマスに配置することが可能です（同じサイズは配置できません）。<br> 最も早く勝利条件となる配置をできたプレーヤーが勝利となります。
        </div>
        <div class="rules">
          <strong>ルール説明②</strong><br>
          <br> ３つのリングが以下のように並んだ場合プレイヤーは勝利となります。<br>
          <br> 1⃣・同じ色で大・中・小または小・中・大の順番に縦・横・斜めのいずれか１列に並んだ場合<br>
          <br>
          <img src="../graphic/junnbann.png" alt="順番のリング" width="250" height="250" style="display: block; margin: auto;" />
        </div>
        <div class="rules">
          <strong>ルール説明③</strong><br>
          <br> 2⃣・同じ大きさで同じ色のリングが、縦・横・斜めのいずれかが１列に並んだ場合<br>
          <br>
          <img src="../graphic/onaji.png" alt="同じ大きさのリング" width="250" height="250" style="display: block; margin: auto;" />
        </div>
        <div class="rules">
          <strong>ルール説明④</strong><br>
          <br> 3⃣・同じ場所に同じ色で大・中・小の３種類のリングが置かれた場合<br>
          <br>
